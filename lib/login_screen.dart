...
import 'database_helper.dart'; // Asegúrate de tener configurado tu cliente de Supabase
import 'home_screen.dart'; // Tu pantalla principal después de iniciar sesión
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12.0),
                    borderSide: BorderSide(color: Color(0xFF376C5C)),
                  ),
              ...
              if (!_isLogin) ...[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Segundo Apellido (opcional)'),
                ),
              ],
              SizedBox(height: 20),
              _isLoading
              ...
              TextButton(
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Recuperación de contraseña')),
                  );
                },
                child: Text(
